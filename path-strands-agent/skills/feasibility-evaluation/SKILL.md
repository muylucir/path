...
추가로, **자율성 요구도**를 별도 축으로 평가하여 적합한 자동화 수준(AI-Assisted Workflow vs Agentic AI)을 판단합니다.
...
| 항목 | 기준 | 최고점 | Reference |
|------|------|--------|-----------|
| **자율성 요구도** | 에이전트 자율 판단 필요 정도 | 10점 | `scoring-criteria.md` |

- 준비도 총점(50점)과는 **독립적**인 평가 축
- 낮은 점수 = AI-Assisted Workflow 적합 (나쁜 것이 아님)
- 높은 점수 = Agentic AI 적합 (더 복잡하지만 유연)
...
**6점 미만** (5점 이하)인 항목은 취약 항목으로 분류됩니다.
