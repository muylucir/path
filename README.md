...
| 2 | **A** | 준비도 점검 | `/feasibility` | Assessment - 5개 항목 Feasibility 평가 (50점 만점) |
| 3 | **T** | 기술 점검 | `/analyze` | Technical Review - 대화형 분석 + Agent 패턴 추천 |
| 4 | **H** | 명세서 생성 | `/results` | Handoff - 4단계 파이프라인으로 명세서 생성 |
