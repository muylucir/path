...
"[project]/path/path-web/lib/prompts.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SYSTEM_PROMPT = `당신은 20년차 소프트웨어 아키텍트이자 AI Agent 전문가 그리고 P.A.T.H (Problem-Agent-Technical-Handoff) 프레임워크를 개발한 전문가입니다.
...
- 낙관적이지 않고 현실적으로 평가
- 리스크를 숨기지 않고 명확히 제시`;
function getInitialAnalysisPrompt(formData) {
    const dataSourceStr = formData.dataSources.filter((ds)=>ds.type && ds.description).map((ds)=>`- ${ds.type}: ${ds.description}`).join("\n");
...
"[project]/path/path-web/app/api/bedrock/analyze/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const prompt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$path$2f$path$2d$web$2f$lib$2f$prompts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getInitialAnalysisPrompt"])(formData);
        const encoder = new TextEncoder();
        const stream = new ReadableStream({
            async start (controller) {
                try {
                    for await (const chunk of (0, __TURBOPACK__imported__module__$5b$project$5d2f$path$2f$path$2d$web$2f$lib$2f$aws$2f$bedrock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["invokeClaudeStream"])(prompt, __TURBOPACK__imported__module__$5b$project$5d2f$path$2f$path$2d$web$2f$lib$2f$prompts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SYSTEM_PROMPT"])){
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e6c28c25._.js.map