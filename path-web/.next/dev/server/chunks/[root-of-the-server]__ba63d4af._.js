...
"[project]/path/path-web/app/api/bedrock/finalize/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
JSON만 출력하세요.`;
        const systemPromptForJson = `${__TURBOPACK__imported__module__$5b$project$5d2f$path$2f$path$2d$web$2f$lib$2f$prompts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SYSTEM_PROMPT"]}

당신은 지금까지의 대화를 바탕으로 최종 분석을 수행하고 JSON 형식으로 출력합니다.
간결하고 정확하게 작성하세요.`;
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$path$2f$path$2d$web$2f$lib$2f$aws$2f$bedrock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["invokeClaude"])(prompt, systemPromptForJson);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ba63d4af._.js.map