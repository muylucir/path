...
답변하시면 최종 분석을 진행합니다. 또는 "분석 완료"를 입력하면 현재 정보로 진행합니다.`}e.s(["SYSTEM_PROMPT",0,t,"getInitialAnalysisPrompt",()=>r])},876916,e=>{"use strict";var t=e.i(467783),r=e.i(163647),n=e.i(97110),o=e.i(298653),i=e.i(854059),s=e.i(320794),a=e.i(322463),l=e.i(360518),d=e.i(218720),c=e.i(235797),p=e.i(227382),u=e.i(205717),h=e.i(542771),v=e.i(919185),f=e.i(939232),g=e.i(193695);e.i(688359);var E=e.i(186082),S=e.i(706797),w=e.i(700121);async function P(e){try{let t=await e.json(),r=(0,w.getInitialAnalysisPrompt)(t),n=new TextEncoder,o=new ReadableStream({async start(e){try{for await(let t of(0,S.invokeClaudeStream)(r,w.SYSTEM_PROMPT))e.enqueue(n.encode(`data: ${JSON.stringify({text:t})}

`));e.enqueue(n.encode("data: [DONE]\n\n")),e.close()}catch(t){e.error(t)}}});return new Response(o,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive"}})}catch(e){return console.error("Error in analyze API:",e),new Response(JSON.stringify({error:"분석 중 오류가 발생했습니다"}),{status:500,headers:{"Content-Type":"application/json"}})}}e.s(["POST",()=>P],868716);var _=e.i(868716);let m=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/bedrock/analyze/route",pathname:"/api/bedrock/analyze",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/path/path-web/app/api/bedrock/analyze/route.ts",nextConfigOutput:"",userland:_}),{workAsyncStorage:T,workUnitAsyncStorage:A,serverHooks:C}=m;function x(){return(0,n.patchFetch)({workAsyncStorage:T,workUnitAsyncStorage:A})}async function R(e,t,n){m.isDev&&(0,o.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let S="/api/bedrock/analyze/route";S=S.replace(/\/index$/,"")||"/";let w=await m.prepare(e,t,{srcPage:S,multiZoneDraftMode:!1});if(!w)return t.statusCode=400,t.end("Bad Request"),null==n.waitUntil||n.waitUntil.call(n,Promise.resolve()),null;let{buildId:P,params:_,nextConfig:T,parsedUrl:A,isDraftMode:C,prerenderManifest:x,routerServerContext:R,isOnDemandRevalidate:y,revalidateOnlyGenerated:k,resolvedPathname:O,clientReferenceManifest:I,serverActionsManifest:b}=w,N=(0,a.normalizeAppPath)(S),D=!!(x.dynamicRoutes[N]||x.routes[O]),F=async()=>((null==R?void 0:R.render404)?await R.render404(e,t,A,!1):t.end("This page could not be found"),null);if(D&&!C){let e=!!x.routes[O],t=x.dynamicRoutes[N];if(t&&!1===t.fallback&&!e){if(T.experimental.adapterPath)return await F();throw new g.NoFallbackError}}let j=null;!D||m.isDev||C||(j="/index"===(j=O)?"/":j);let U=!0===m.isDev||!D,$=D&&!U;b&&I&&(0,s.setManifestsSingleton)({page:S,clientReferenceManifest:I,serverActionsManifest:b});let M=e.method||"GET",H=(0,i.getTracer)(),q=H.getActiveScopeSpan(),L={params:_,prerenderManifest:x,renderOpts:{experimental:{authInterrupts:!!T.experimental.authInterrupts},cacheComponents:!!T.cacheComponents,supportsDynamicResponse:U,incrementalCache:(0,o.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:T.cacheLife,waitUntil:n.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,n,o)=>m.onRequestError(e,t,n,o,R)},sharedContext:{buildId:P}},K=new l.NodeNextRequest(e),W=new l.NodeNextResponse(t),V=d.NextRequestAdapter.fromNodeNextRequest(K,(0,d.signalFromNodeResponse)(t));try{let s=async e=>m.handle(V,L).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=H.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==c.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let n=r.get("next.route");if(n){let t=`${M} ${n}`;e.setAttributes({"next.route":n,"http.route":n,"next.span_name":t}),e.updateName(t)}else e.updateName(`${M} ${S}`)}),a=!!(0,o.getRequestMeta)(e,"minimalMode"),l=async o=>{var i,l;let d=async({previousCacheEntry:r})=>{try{if(!a&&y&&k&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let i=await s(o);e.fetchMetrics=L.renderOpts.fetchMetrics;let l=L.renderOpts.pendingWaitUntil;l&&n.waitUntil&&(n.waitUntil(l),l=void 0);let d=L.renderOpts.collectedTags;if(!D)return await (0,u.sendResponse)(K,W,i,L.renderOpts.pendingWaitUntil),null;{let e=await i.blob(),t=(0,h.toNodeOutgoingHttpHeaders)(i.headers);d&&(t[f.NEXT_CACHE_TAGS_HEADER]=d),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==L.renderOpts.collectedRevalidate&&!(L.renderOpts.collectedRevalidate>=f.INFINITE_CACHE)&&L.renderOpts.collectedRevalidate,n=void 0===L.renderOpts.collectedExpire||L.renderOpts.collectedExpire>=f.INFINITE_CACHE?void 0:L.renderOpts.collectedExpire;return{value:{kind:E.CachedRouteKind.APP_ROUTE,status:i.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:n}}}}catch(t){throw(null==r?void 0:r.isStale)&&await m.onRequestError(e,t,{routerKind:"App Router",routePath:S,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:$,isOnDemandRevalidate:y})},!1,R),t}},c=await m.handleResponse({req:e,nextConfig:T,cacheKey:j,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:x,isRoutePPREnabled:!1,isOnDemandRevalidate:y,revalidateOnlyGenerated:k,responseGenerator:d,waitUntil:n.waitUntil,isMinimalMode:a});if(!D)return null;if((null==c||null==(i=c.value)?void 0:i.kind)!==E.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==c||null==(l=c.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});a||t.setHeader("x-nextjs-cache",y?"REVALIDATED":c.isMiss?"MISS":c.isStale?"STALE":"HIT"),C&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let g=(0,h.fromNodeOutgoingHttpHeaders)(c.value.headers);return a&&D||g.delete(f.NEXT_CACHE_TAGS_HEADER),!c.cacheControl||t.getHeader("Cache-Control")||g.get("Cache-Control")||g.set("Cache-Control",(0,v.getCacheControlHeader)(c.cacheControl)),await (0,u.sendResponse)(K,W,new Response(c.value.body,{headers:g,status:c.value.status||200})),null};q?await l(q):await H.withPropagatedContext(e.headers,()=>H.trace(c.BaseServerSpan.handleRequest,{spanName:`${M} ${S}`,kind:i.SpanKind.SERVER,attributes:{"http.method":M,"http.target":e.url}},l))}catch(t){if(t instanceof g.NoFallbackError||await m.onRequestError(e,t,{routerKind:"App Router",routePath:N,routeType:"route",revalidateReason:(0,p.getRevalidateReason)({isStaticGeneration:$,isOnDemandRevalidate:y})},!1,R),D)throw t;return await (0,u.sendResponse)(K,W,new Response(null,{status:500})),null}}e.s(["handler",()=>R,"patchFetch",()=>x,"routeModule",()=>m,"serverHooks",()=>C,"workAsyncStorage",()=>T,"workUnitAsyncStorage",()=>A],876916)},5389,e=>{e.v(t=>Promise.all(["server/chunks/[externals]_node:async_hooks_b485b2a4._.js"].map(t=>e.l(t))).then(()=>t(478500)))},852973,e=>{e.v(t=>Promise.all(["server/chunks/[root-of-the-server]__19e5bbe9._.js"].map(t=>e.l(t))).then(()=>t(734332)))},510247,e=>{e.v(t=>Promise.all(["server/chunks/[root-of-the-server]__972ff848._.js"].map(t=>e.l(t))).then(()=>t(135942)))},843565,e=>{e.v(t=>Promise.all(["server/chunks/03239_@aws-sdk_credential-provider-sso_dist-es_8f055ca1._.js"].map(t=>e.l(t))).then(()=>t(519961)))},873799,e=>{e.v(t=>Promise.all(["server/chunks/[root-of-the-server]__12b58650._.js"].map(t=>e.l(t))).then(()=>t(888625)))},854340,e=>{e.v(t=>Promise.all(["server/chunks/[root-of-the-server]__56cd8f1c._.js"].map(t=>e.l(t))).then(()=>t(321009)))},131643,e=>{e.v(t=>Promise.all(["server/chunks/03239_14ed4585._.js"].map(t=>e.l(t))).then(()=>t(41425)))},49465,e=>{e.v(t=>Promise.all(["server/chunks/[root-of-the-server]__e2eabf5f._.js","server/chunks/03239_@aws-sdk_nested-clients_dist-es_submodules_sso-oidc_index_6687fe05.js"].map(t=>e.l(t))).then(()=>t(195469)))},169902,e=>{e.v(t=>Promise.all(["server/chunks/03239_@smithy_core_dist-es_submodules_event-streams_index_cf2ca7be.js"].map(t=>e.l(t))).then(()=>t(431737)))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__cbd7f3d6._.js.map