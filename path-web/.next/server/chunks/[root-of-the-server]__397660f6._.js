...
답변하시면 최종 분석을 진행합니다. 또는 "분석 완료"를 입력하면 현재 정보로 진행합니다.`}e.s(["SYSTEM_PROMPT",0,t,"getInitialAnalysisPrompt",()=>r])},91378,e=>{"use strict";var t=e.i(67783),r=e.i(63647),n=e.i(97110),o=e.i(98653),i=e.i(54059),s=e.i(20794),a=e.i(22463),l=e.i(60518),d=e.i(18720),c=e.i(35797),p=e.i(27382),u=e.i(5717),h=e.i(42771),f=e.i(19185),g=e.i(39232),v=e.i(93695);e.i(88359);var E=e.i(86082),S=e.i(6797),_=e.i(121);async function P(e){try{let{conversation:t}=await e.json(),r=t.map(e=>`${e.role.toUpperCase()}: ${e.content}`).join("\n\n"),n=`다음은 지금까지의 분석 내용입니다:
