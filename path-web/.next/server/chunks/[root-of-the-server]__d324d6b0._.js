...
답변하시면 최종 분석을 진행합니다. 또는 "분석 완료"를 입력하면 현재 정보로 진행합니다.`}e.s(["SYSTEM_PROMPT",0,t,"getInitialAnalysisPrompt",()=>r])},419627,e=>{"use strict";var t=e.i(467783),r=e.i(163647),n=e.i(97110),o=e.i(298653),i=e.i(854059),s=e.i(320794),a=e.i(322463),l=e.i(360518),d=e.i(218720),c=e.i(235797),p=e.i(227382),u=e.i(205717),h=e.i(542771),f=e.i(919185),v=e.i(939232),g=e.i(193695);e.i(688359);var E=e.i(186082),S=e.i(706797),w=e.i(700121);async function P(e){try{let{conversation:t,userMessage:r}=await e.json(),n=t.map(e=>`${e.role.toUpperCase()}: ${e.content}`).join("\n\n"),o=`${n}
